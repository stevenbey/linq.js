...
Assert.equals(numbers.aggregate(function (v, n) { return v + n; }), 11, "aggregate (numeric array): with accumulator");
Assert.equals(numbers.aggregate(function (v, n) { return v + n; }, 10), 21, "aggregate (numeric array): with accumulator and numeric seed");
Assert.equals(numbers.aggregate(function (v, n) { return v + n; }, 10, function (v) { return ("The value is: " + v); }), "The value is: 21", "aggregate (numeric array): with accumulator, numeric seed and selector");
Assert.equals(objects.aggregate(function (v, n) { v.x += n.x; return v; }).x, 11, "aggregate (object array): with accumulator");
Assert.equals(objects.aggregate(function (v, n) { v.x += n.x; return v; }, { x: 10 }).x, 21, "aggregate (object array): with accumulator and object seed");
Assert.equals(objects.aggregate(function (v, n) { v.x += n.x; return v; }, { x: 10 }, function (v) { return v.x; }), 21, "aggregate (object array): with accumulator, object seed and selector");
